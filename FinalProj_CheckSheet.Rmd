...
author: "Taksh Anand & Sadanidan Balamurugan"
date: "2/24/20"
...
Primary data set[crime]: line 60
Secondary data set[zipgeography]: line 68
...
(A) .Rmd Line number(s) for general data wrangling: 93, 109,135,153,307
(B) .Rmd Line number(s) for a join operation: 281
(C) .Rmd Line number(s) for a spread or gather operation (or equivalent):
(D) .Rmd Line number(s) for use of regular expressions: 297-312
(E) .Rmd Line number(s) for use of reduction and/or transformation functions: 137,155,173,183,203,211
(F) .Rmd Line number(s) for use of user-defined functions: 66-71, 307-316
...
(A) .Rmd Line number(s) for use of mulitple different geoms: 394, 416, 438, 462,480
(B) .Rmd Line number(s) for use of multiple aesthetics: 392, 414,436,460,478
(C) .Rmd Line number(s) for use of layered graphics: 360-368, 476-484
